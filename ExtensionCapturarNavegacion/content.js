...
function DatosEvento(id, name, elementType, typeEvent, value) {
    this.id = id;
    this.name = name;
...
function updateValue(e) {
    var datos = new DatosEvento(e.srcElement.id, event.srcElement.name, e.srcElement.localName, e.type, e.srcElement.value);
